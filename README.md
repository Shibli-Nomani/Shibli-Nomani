...
- 🌱 I’m currently learning Data Science, Machine Learning, Deep Learning, Artificial Intellegence, and Cyber Security.
...
![HuggingFace](https://img.shields.io/badge/Hugging%20Face-%23FFD21E.svg?style=for-the-badge&logo=HuggingFace&logoColor=black) ![Groq](https://img.shields.io/badge/Groq-%23FF4B4B.svg?style=for-the-badge&logo=groq&logoColor=white) ![LLM](https://img.shields.io/badge/LLM-%230062FF.svg?style=for-the-badge&logo=openai&logoColor=white) ![LangChain](https://img.shields.io/badge/LangChain-%2300BFA6.svg?style=for-the-badge&logo=Chainlink&logoColor=white) ![LangGraph](https://img.shields.io/badge/LangGraph-%235C2D91.svg?style=for-the-badge&logo=graph&logoColor=white)
...
### 🔹 AI-Powered RAG Chatbot Agent | FastAPI, Langgraph, ChromaDB  
**GitHub Repo:** [AI-Powered Chatbot Repo](https://github.com/Shibli-Nomani/AI-Powered-Chatbot-Research-Analysis-with-FastAPI)  
- Built a DOC/Image-based Q&A chatbot Webapp using OCR, FastAPI endpoints, Hugging Face embeddings, ChromaDB + SQLite3 for vector search, LangGraph workflows, and RAG for context-aware responses.  

### 🔹 ChefGuard AI | YOLOv11, MTCNN, InceptionResnetV1, FAISS, Django  
**GitHub Repo:** [ChefGuard AI Repo](https://github.com/Shibli-Nomani/ChefGuardAI-Kitchen-Hygine--and-Face-Detection)  
- AI system for kitchen hygiene using YOLOv11 for PPE detection (bouffant, apron, gloves), MTCNN & InceptionResnetV1 for facial recognition, and FAISS for name matching.  
- Applies IoU and heuristic face-body mapping to generate person-wise violation reports (wearing/missing with names), deployed via Django as a web application.  

### 🔹 Emotion-Aware Chatbot | DeepFace, LLaMA 2, VITS, Gradio  
**GitHub Repo:** [Emotion-Aware Chatbot Repo](https://github.com/Shibli-Nomani/EmoGuide-Emotion-Aware-Conversations-with-Captain-Feels)  
- Detect facial emotions and generate empathetic text/audio responses with DeepFace, LLaMA 2, and VITS.  
- Deploy with Gradio using dynamic emotion-based logic.  

### 🔹 Hugging Face Multimodal Projects | Gradio, Transformers, LLM  
**GitHub Repo:** [Hugging Face Projects Repo](https://github.com/Shibli-Nomani/Open-Source-Models-with-Hugging-Face)  
- Deploy transformer models for text, audio, and image tasks in Gradio apps.  

### 🔹 Air Ticket Price Prediction | Docker, Airflow, MLFlow, AWS  
**GitHub Repo:** [Air Ticket Price Prediction Repo](https://github.com/Shibli-Nomani/MLOps-Project-AirTicketPricePrediction)  
- Build end-to-end MLOps pipeline with model drift detection and artifact storage.  

### 🔹 Brain Tumor Detection | VGG19 CNN  
**GitHub Repo:** [Brain Tumor Detection Repo](https://github.com/Shibli-Nomani/MRI-IMAGE-FOR-BRAIN-TUMOR-CLASSIFICATION-USING-VGG19-and-Fine-Tuned-DENSE-LAYER/blob/main/mri-of-brain-tumor-classification-using-vgg19-fine-tuned-dense-layer.ipynb)  
- Develop CNN classifier with 92% accuracy on MRI data, using data augmentation.  

### 🔹 Uber Fare Prediction in New York City | Python, Scikit-Learn  
**GitHub Repo:** [Uber Fare Prediction Repo](https://github.com/Shibli-Nomani/project--Uber-Fare-Prediction-in-New-York-City-/tree/main)  
- Perform exploratory data analysis and build regression models using various machine learning algorithms.  
